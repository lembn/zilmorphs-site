    ...
    return (
        ...
        >
            <Box align="center" width={{ max: "350px" }} flex="grow">
                ...
                <Para>
                    Zillqa bridge has echoed across the multiverse. The balance
                    was disturbed! Two worlds colided and now 8000 zilmorphs
                    have invaded our dimension! You can only get them with
                    assets from the other worlds: #zWBTC, #zETH, #zUSDT.
                </Para>
                <Para>
                ...
                <Para>
                    ...
                    zWBTC, zETH, zUSDT. The morphs starting price is ~1$ in the
                    other worldly assets, each next morph is 1$ more, the
                    earlier you buy the cheaper!
                </Para>
                <Para>
                    There are 3 marketplaces for morphs all have an equivalent
                ...
                <Para>
                    ...
                    we will be doing that with the 100 zilmorphs we reserved
                    from the 8000 existing.
                </Para>
                <Para>
                    Owning a Zilmorph will allow you to take part in upcoming
                    RNG games with $ZIL prices. Zilmorph with better Strength
                    Agility or Inteligence stats will increase your chances in
                    the games.
                </Para>
                <Para>
                    Zillmorphs are scarce, there is only 8000 of them, and they
                    get more expensive very fast! Each next zilmorph is around
                    1$ more than the previous, with a starting price of 1$.
                </Para>
                <Para>
                    Zilmorphs were created by machine learning algorithms
                    trained on pixel art and are unique! Zilmorph names were
                    also created by machine learning!
                </Para>
                <Heading level="3">Roadmap</Heading>
                <Para>
                    Zimorphs will be sold for the Zilliqa bridge assets zWBTC,
                    zETH, zUSDT.
                </Para>
                <Para>
                    Zilmorph airdrops for zilmorph owners! (Using the 100
                    zilmorphs reserved for marketing purposes)
                </Para>
                <Para>Zilmorphs join a NFT marketplace!</Para>
                <Para>
                    Zilmorphs release RNG games with $ZIL prices, having a
                    stronger zilmorph (more agility, strength or inteligence)
                    will increase your chances in the games!
                </Para>
            </Box>
